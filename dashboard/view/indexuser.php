...
<html>
  ...
  <title>Usuário - Visão Geral</title>
...
<body>
  ...
  <div class="container">
	  <?php
		...
		echo "<h1 class='text-center mb-3 mt-3'>Olá ".$_SESSION['sess_name_user']." você é um usuário!</h1>";

	  ?>

    <p>Nome: <?=$_SESSION['sess_name_user']?></p>
    <p>Email: <?=$_SESSION['sess_email_user']?></p>
    <p><img src="../<?=$_SESSION['sess_foto_user']?>" alt=""></p>
